...
export function setupWebSocketCallbacks(gameLoop: (time: number) => void): void
{
    ...
    wsClient.onGameOver = (winner: 'player1' | 'player2', score1: number, score2: number, isTournament?: boolean, shouldDisconnect?: boolean) => {
        showGameOver(winner, score1, score2, isTournament, shouldDisconnect);
    };
